...
class Player {
    ...
    setupModel() {
        ...
        world.loadFbx('player', 'https://s3-ap-southeast-2.amazonaws.com/c17-mountain.kvn.io/assets/models/player/player@skateboarding.fbx', true)
        world.loadFbx('playerDying', 'https://s3-ap-southeast-2.amazonaws.com/c17-mountain.kvn.io/assets/models/player/player@dying.fbx', false)
        world.loadFbx('snowboard', 'https://s3-ap-southeast-2.amazonaws.com/c17-mountain.kvn.io/assets/models/snowboard/snowboard.fbx', true)
...
class Mountain {
    constructor(world, player) {
        ...
        const snowMap = new THREE.TextureLoader().load('https://s3-ap-southeast-2.amazonaws.com/c17-mountain.kvn.io/assets/materials/snow.jpg')
        ...
        this.world.loadFbx('tree', 'https://s3-ap-southeast-2.amazonaws.com/c17-mountain.kvn.io/assets/models/tree/tree.fbx', false)
        this.world.onLoaded(() => {
